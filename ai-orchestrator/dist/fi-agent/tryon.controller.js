...
let TryOnController = class TryOnController {
    ...
    async createJob(body) {
        return await this.tryOnService.createTryOnJob(body.userId, body.productId, body.userImageUrl, body.jobId);
    }
};
...
], TryOnController.prototype, "createJob", null);
exports.TryOnController = TryOnController = __decorate([
    (0, common_1.Controller)('api/v1/ai/tryon'),
