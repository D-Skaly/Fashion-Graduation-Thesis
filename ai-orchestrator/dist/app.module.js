...
exports.AppModule = AppModule = __decorate([
    (0, common_1.Module)({
        controllers: [stylist_controller_1.StylistController, strategist_controller_1.StrategistController, health_controller_1.HealthController],
        providers: [llm_client_1.LlmClient, spring_fiagent_gateway_1.SpringFiAgentGateway, stylist_service_1.StylistService, strategist_service_1.StrategistService],
    })
], AppModule);
