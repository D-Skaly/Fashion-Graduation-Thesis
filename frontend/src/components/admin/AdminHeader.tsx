            ...
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="flex items-center gap-4 h-12 py-2 px-4 rounded-2xl hover:bg-zinc-900 transition-all border border-transparent hover:border-zinc-800">
                <div className="hidden sm:flex flex-col items-end">
                  ...
                  <span className="text-[10px] text-zinc-500 font-medium">{profile?.role || "System Administrator"}</span>
                </div>
            ...
            <DropdownMenuContent align="end" className="w-64 p-2 bg-zinc-900 border-zinc-800 text-zinc-100 rounded-2xl shadow-2xl">
              ...
              <div className="p-1">
                <DropdownMenuItem asChild className="rounded-xl focus:bg-zinc-800 focus:text-white cursor-pointer py-2.5">
                  <a href="/" target="_blank" rel="noopener noreferrer" className="flex items-center w-full">
                    <ExternalLink className="mr-3 h-4 w-4 text-zinc-500" />
                    <span className="text-xs font-bold tracking-wider">Public Interface</span>
                  </a>
                </DropdownMenuItem>
                <DropdownMenuItem className="rounded-xl focus:bg-zinc-800 focus:text-white cursor-pointer py-2.5">
                  ...
                  <span className="text-xs font-bold tracking-wider">Profile Access</span>
                </DropdownMenuItem>
                <DropdownMenuItem className="rounded-xl focus:bg-zinc-800 focus:text-white cursor-pointer py-2.5">
                  <Settings className="mr-3 h-4 w-4 text-zinc-500" />
                  <span className="text-xs font-bold tracking-wider">System Config</span>
                </DropdownMenuItem>
              </div>
              <DropdownMenuSeparator className="bg-zinc-800" />
              <div className="p-1">
                ...
                >
                  ...
                  <span className="text-xs font-bold tracking-wider">Emergency Logout</span>
                </DropdownMenuItem>
              </div>
            </DropdownMenuContent>
          </DropdownMenu>
